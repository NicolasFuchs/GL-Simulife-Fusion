...
public class MyWorld extends AWorld {
	 ...
	 * WhiteShark) { WhiteShark w = (WhiteShark) creature; w.setPosition(row, col);
	 * } if (creature instanceof HammerheadShark) { HammerheadShark h =
	...
	public void init(boolean isChessLife) {
		if (isChessLife) {
			King kW = (King) pieceFactory.createPiece(CreatureType.KING, false, new Point(4, 7));
			King kB = (King) pieceFactory.createPiece(CreatureType.KING, true, new Point(4, 0));
			Bishop bW1 = (Bishop) pieceFactory.createPiece(CreatureType.BISHOP, false, new Point(2, 6));
			Bishop bW2 = (Bishop) pieceFactory.createPiece(CreatureType.BISHOP, false, new Point(5, 6));
			Bishop bB1 = (Bishop) pieceFactory.createPiece(CreatureType.BISHOP, true, new Point(2, 1));
			Bishop bB2 = (Bishop) pieceFactory.createPiece(CreatureType.BISHOP, true, new Point(5, 1));
			Knight kW1 = (Knight) pieceFactory.createPiece(CreatureType.KNIGHT, false, new Point(0, 4));
			Knight kW2 = (Knight) pieceFactory.createPiece(CreatureType.KNIGHT, false, new Point(7, 4));
			Queen qW = (Queen) pieceFactory.createPiece(CreatureType.QUEEN, false, new Point(3, 0));
			Queen qB = (Queen) pieceFactory.createPiece(CreatureType.QUEEN, true, new Point(3, 7));
			Pawn pB1 = (Pawn) pieceFactory.createPiece(CreatureType.PAWN, false, new Point(0, 7));
			Pawn pB2 = (Pawn) pieceFactory.createPiece(CreatureType.PAWN, false, new Point(7, 7));
